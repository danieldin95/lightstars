...
func TestFmtPath(t *testing.T) {
	...
	assert.Equal(t, "/lightstar/datastore/02", PATH.Unix("02"), "")
	assert.Equal(t, "/lightstar/datastore/99", PATH.Unix("99"), "")
	assert.Equal(t, "a3", PATH.Unix("a3"), "")
