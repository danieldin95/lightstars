...
export class Alert {
    ...
    static show(parent, level, message) {
        // history is generated by backend, trigger a refresh event only.
        window.dispatchEvent(new CustomEvent("lightstar:history:append"));
        if (parent === "tasks" || parent === "#tasks" || parent === "notice") {
            return;
        }
